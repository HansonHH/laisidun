...
+function (a, b) {
    ...
    c.defaults = {googleApiKey: null, googleAnalyticsId: null, smoothScroll: !0}, c.breakpoint = {
        ...
        c.topbar(), c.parallax(), c.carousel(), c.scrolling(), c.counter(), c.aos(), c.typed(), c.contact(), c.mailer(), c.constellation(), c.shuffle(), a(document).on("click", ".video-wrapper .btn", function () {
